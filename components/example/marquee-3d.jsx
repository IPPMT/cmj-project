...
const Marquee3D = () => {
  return (
    (<div
      className="relative flex h-full w-96 flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-zinc-200 bg-white px-20 md:shadow-xl dark:border-zinc-800 dark:bg-zinc-950">
