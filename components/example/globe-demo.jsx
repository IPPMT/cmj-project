...
export default function GlobeDemo() {
  return (
    (<div
      className="relative flex h-full w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg border border-zinc-200 bg-white px-40 pb-40 pt-8 md:pb-60 md:shadow-xl dark:border-zinc-800 dark:bg-zinc-950">
      <span
