...
const MarqueeLogos = () => {
  return (
    (<div
      className="relative flex h-full w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-zinc-200 bg-white py-20 md:shadow-xl dark:border-zinc-800 dark:bg-zinc-950">
